...
│   ├── BideApp.swift              # @main, scene-phase, BG refresh + delegate adaptor
│   ├── BideAppDelegate.swift      # Quick Actions + Spotlight continuation
│   ├── RootView.swift             # onboarding vs ready (Reduce-Motion aware)
│   ├── AppIntents/                # Siri / Shortcuts intents + AppShortcutsProvider
│   ├── State/                     # AppState, ShortcutAction, WhatsNewPlanner, UITestMode
│   ├── Theme/                     # BideTheme (asset-catalog colors, type, spacing)
│   ├── Components/                # ThumbnailView, SkeletonRow, RecentCaptureBadge, HelpToolbarButton
│   ├── Onboarding/                # 3-page intro + permission request
│   ├── Dashboard/                 # DashboardView, WhatsNewView, RefreshCoalescer, ModuleCard
│   ├── Modules/                   # 8 modules (see below)
│   ├── Models/                    # AssetSummaries, IndexedAsset, ReclaimSession, RecencyRule
│   ├── Services/                  # PhotoLibraryService, VisionService, MetricsService,
│   │                              #   BackgroundRefresh*, BideSpotlightIndexer, BideHaptics,
│   │                              #   StorageHealth, BideSignposts, observer
...
│   ├── Settings/                  # SettingsView, HowBideWorksView, AcknowledgementsView, DiagnosticsView
│   ├── Localizable.xcstrings      # String Catalog (en source; auto-extracted)
│   └── LaunchScreen.storyboard    # solid-brand launch screen
├── BideShared/              # code compiled into BOTH app + widget (WidgetSharedData)
├── BideWidget/              # WidgetKit extension: Home Screen + Lock Screen widgets
├── BideTests/               # XCTest unit tests (225 tests as of v1.2)
├── BideUITests/             # XCUITest: navigation, accessibility audit, screenshot capture
├── product/
...
- **xcodebuild test** — all tests pass (225 unit + 7 UI as of v1.2), coverage uploaded to SonarCloud
